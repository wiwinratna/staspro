...
@section('content')
  ...
  @php
    ...
    $badgeClass = $status==='submit' ? 'badge-submit'
                ...
                : ($status==='done' ? 'badge-done' : 'badge-reject'));
  ...
  <section class="hero">
    <div class="hero-inner">
      <h1 class="title">Detail Reimbursement</h1>
      <p class="sub">
        No Request: <b class="tnum">{{ $trx->no_request }}</b>
        <span class="ms-2 badge-pill {{ $badgeClass }}">
          <i class="bi bi-info-circle"></i> {{ $statusLabel }}
        </span>
      </p>
  ...
  <div class="row g-3">
    <div class="col-lg-7">
      ...
      <div class="card-box mt-3">
        <div class="label">Approval & Pembayaran</div>
        <div class="row g-3">
          <div class="col-md-4">
    ...
    <div class="col-lg-5">
      {{-- Bukti wajib dari awal --}}
      <div class="card-box">
        <div class="d-flex justify-content-between align-items-center">
          <div class="label mb-0">Bukti Reimbursement</div>
            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Bukti Reimbursement</h5>
