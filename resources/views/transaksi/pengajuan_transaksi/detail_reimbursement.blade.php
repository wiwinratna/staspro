{{-- resources/views/transaksi/pengajuan_transaksi/detail_reimbursement.blade.php --}}
...
@section('content')
  ...
  <section class="detail-hero">
    <div class="detail-hero-inner">
      <h1 class="detail-title">Detail Reimbursement</h1>
    ...
    <div class="col-lg-5">
      ...
      <div class="detail-section mb-3">
        <div class="section-header">
          ...
          <h6>Bukti Reimbursement / Nota (Pengaju)</h6>
            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header" style="background:linear-gradient(135deg, rgba(139,92,246,.06), rgba(139,92,246,.02));">
                  <h5 class="modal-title"><i class="bi bi-image me-2" style="color:#7c3aed;"></i>Bukti Reimbursement</h5>
        ...
        @if(!empty($trx->bukti_transfer))
          <div class="mt-3 px-3 pb-3 text-end">
                ...
                <div class="row g-2">
                  ...
                  <div class="col-md-6 d-flex align-items-end pb-1">
                    <div class="form-check form-switch">
                      ...
                      <input class="form-check-input" type="checkbox" name="is_talangan" value="1" id="is_talangan_reimb">
                      <label class="form-check-label fw-bold" for="is_talangan_reimb">Tandai sebagai Talangan</label>
                    </div>
                  </div>
                  <div class="col-12 d-flex gap-2 justify-content-end mt-3">
                    <button type="submit" class="btn-brand"><i class="bi bi-check2"></i> Setujui & Selesaikan</button>
