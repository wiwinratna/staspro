{{-- resources/views/transaksi/pengajuan_transaksi/create_pengajuan.blade.php --}}
...
@section('content')
  ...
  <section class="hero">
    <div class="hero-inner">
      <h1 class="title">Pengajuan Dana</h1>
      <p class="sub">Ajukan dana terlebih dahulu. Bukti diupload setelah dana disetujui (approve).</p>
  ...
  <div class="card-form">
    <form method="POST" action="{{ route('pengajuan_transaksi.store_pengajuan') }}">
      @csrf
      ...
      <div class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <input type="text" name="nama_bank" class="form-control field" value="{{ old('nama_bank') }}" placeholder="Contoh: BCA" required>
        </div>
...
@push('scripts')
<script>
  // Subkategori by project (konsisten: route name pengajuan_transaksi.subkategori)
  (function(){
