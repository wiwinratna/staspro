          ...
          <form action="{{ route('sumberdana.store') }}" method="POST">
            ...
            <div class="row g-3">
              <div class="col-md-4">
                ...
                <select id="tipe_project" name="tipe_project"
              ...
              <div class="col-md-4">
                ...
                <input type="text" id="nama_sumber_dana" name="nama_sumber_dana"
                  ...
                  placeholder="Contoh: DRPTM, KEDAIREKA, LPDP" value="{{ old('nama_sumber_dana') }}">
              ...
              <div class="col-md-4">
                ...
                <select id="jenis_pendanaan" name="jenis_pendanaan"
                  ...
                  <option value="eksternal" {{ old('jenis_pendanaan') == 'eksternal' ? 'selected' : '' }}>Eksternal
                  </option>
                </select>
            ...
            <select id="subkategori" name="subkategori[]" multiple autocomplete="off">
              @if(!empty($listSubkategori))
                @foreach($listSubkategori as $item)
                  <option value="{{ $item->nama }}" @if(collect(old('subkategori', []))->contains($item->nama)) selected
                  @endif>
                    {{ $item->nama }}
                  </option>
                @endforeach
