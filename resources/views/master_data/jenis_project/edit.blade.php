...
@section('title', 'Edit Jenis Project')
@section('content')
<div class="card shadow-sm border-0 rounded-4 mt-3">
    <div class="card-body p-4">
        <h4 class="mb-4">Edit Jenis Project</h4>
        <form action="{{ route('jenis-project.update', $data->id) }}" method="POST">
            @csrf @method('PUT')
            <div class="row mb-3">
                <div class="col-md-6">
            ...
            <a href="{{ route('jenis-project.index') }}" class="btn btn-light px-4">Batal</a>
        </form>
    </div>
</div>
@endsection