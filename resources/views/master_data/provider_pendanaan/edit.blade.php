...
@section('title', 'Edit Provider Pendanaan')
@section('content')
<div class="card shadow-sm border-0 rounded-4 mt-3">
    <div class="card-body p-4">
        <h4 class="mb-4">Edit Provider Pendanaan</h4>
        <form action="{{ route('provider-pendanaan.update', $data->id) }}" method="POST">
            @csrf @method('PUT')
            <div class="row mb-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="singkatan" class="form-control" value="{{ $data->kode ?? $data->singkatan }}">
                </div>
            </div>
            <div class="mb-3">
