...
@section('content')
  <section class="hero">
    <div class="hero-inner">
      <div class="hero-left">
        <h1 class="title">Komponen Biaya</h1>
        <p class="sub">Kelola daftar Komponen Biaya.</p>
      </div>
      <div class="tools-row">
        <a href="{{ route('komponen-biaya.create') }}" class="btn btn-brand"><i class="bi bi-plus-lg"></i> Tambah Data</a>
      </div>
    </div>
  </section>
            ...
            <tr>
              ...
              <td class="text-center">
                <div class="d-flex justify-content-center gap-2">
                  <a href="{{ route('komponen-biaya.edit', $r->id) }}" class="btn btn-warning btn-sm"><i class="bi bi-pencil-square"></i></a>
                  <form action="{{ route('komponen-biaya.destroy', $r->id) }}" method="POST" class="d-inline" data-id="{{ $r->id }}">
                    @csrf @method('DELETE')
