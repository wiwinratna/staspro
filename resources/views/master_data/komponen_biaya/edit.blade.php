...
<div class="card shadow-sm border-0 rounded-4 mt-3">
    <div class="card-body p-4">
        <h4 class="mb-4">Edit Komponen Biaya</h4>
        <form action="{{ route('komponen-biaya.update', $data->id) }}" method="POST">
            @csrf @method('PUT')
            <div class="row mb-3">
                <div class="col-md-6">
            ...
            <a href="{{ route('komponen-biaya.index') }}" class="btn btn-light px-4">Batal</a>
        </form>
    </div>
</div>
@endsection